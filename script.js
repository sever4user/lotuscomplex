...
const projectsData = [
  {
    ...
    desc: "kletka is a popular indie co-op horror set in a universe of samosbor, a russian internet myth about a world made up of one giant, endless panel high-rise buildin.<br />kletka received strong praise from players, reaching 6000+ steam reviews with 90% positive ratings, 400k copies sold and millions of views across youtube.<br />i have created two soundtracks for the main menu and one of the game's locations. i'm currently actively collaborating with the developer",
    links: [
